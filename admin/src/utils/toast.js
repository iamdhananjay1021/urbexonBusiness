/**
 * toast.js — fires the same "api:error" event api/adminApi.js's interceptor
 ...
 * components can show a success/info/warning toast without wiring up
 * their own local useToast()+<Toast/> pair.
 */
