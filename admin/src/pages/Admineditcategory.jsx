    ...
    if (loading) return (
        <div style={{ fontFamily: "var(--adm-font-sans)", maxWidth: 640, margin: "0 auto" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
                <Skeleton width={78} height={36} radius={10} />
                <div>
                    <Skeleton width={140} height={20} />
                    <div style={{ marginTop: 8 }}><Skeleton width={180} height={12} /></div>
                </div>
            </div>
    ...
    return (
        <div style={{ fontFamily: "var(--adm-font-sans)", maxWidth: 640, margin: "0 auto" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
                ...
                <div>
                    <h1 style={{ fontSize: 20, fontWeight: 700, color: "var(--adm-text-primary)", margin: 0 }}>Edit Category</h1>
                    <p style={{ fontSize: 12, color: "var(--adm-muted)", marginTop: 2 }}>Update category details</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit}>
                <Card style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                    ...
                    <FormField label={<>Category Image{hintSpan("(upload new to replace)")}</>}>
                        {!preview ? (
                            <label style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", width: "100%", height: 90, border: "2px dashed var(--adm-border)", borderRadius: "var(--adm-radius-md)", cursor: "pointer", background: "var(--adm-surface-alt)" }}>
                                <FiUpload size={16} color="var(--adm-muted)" style={{ marginBottom: 5 }} />
                                <p style={{ fontSize: 12, color: "var(--adm-text-secondary)" }}>{currentImage ? "Upload new to replace" : "Upload category image"}</p>
