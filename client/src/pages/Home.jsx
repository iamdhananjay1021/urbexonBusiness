 ...
 * ─ Categories now come from the shared useCategories hook (deduped/cached
 *   across Navbar + Home) instead of a page-local fetchActiveCategories call.
 */
...
const Home = () => {
    ...
    /* Categories now come from the shared, cached/deduped hook — no more
       page-local fetchActiveCategories() call or _homeCache.categories. */
